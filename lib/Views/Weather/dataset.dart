...
List<Weather> sevenDay = [
  Weather(
      max: 20, min: 14, image: "assets/rainy_2d.png", day: "Mon", name: "ممطر"),
  Weather(
      max: 22,
      min: 16,
      ...
      name: "برق"),
  Weather(
      max: 19, min: 13, image: "assets/rainy_2d.png", day: "Wed", name: "ممطر"),
  Weather(
      max: 18, min: 12, image: "assets/snow_2d.png", day: "Thu", name: "Snow"),
  Weather(
      max: 23, min: 19, image: "assets/sunny_2d.png", day: "Fri", name: "مشمس"),
  Weather(
      max: 25, min: 17, image: "assets/rainy_2d.png", day: "Sat", name: "ممطر"),
  Weather(
      max: 21, min: 18, image: "assets/thunder_2d.png", day: "Sun", name: "برق")
];
